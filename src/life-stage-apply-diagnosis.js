...
function show(profile) {
  ...
  style.textContent = `
    ...
    #${DIAGNOSIS_ID} .eyebrow { color: rgba(186,230,253,.70); font-size: 10px; font-weight: 950; letter-spacing: .24em; text-transform: uppercase; }
    #${DIAGNOSIS_ID} h1 { max-width: 340px; font-size: clamp(34px, 11vw, 48px); line-height: .94; letter-spacing: -.055em; font-weight: 950; text-shadow: 0 12px 34px rgba(0,0,0,.32); }
    #${DIAGNOSIS_ID} .story-body { max-width: 340px; color: rgba(248,253,255,.84); font-size: clamp(14px, 3.65vw, 16px); line-height: 1.46; font-weight: 760; }
    #${DIAGNOSIS_ID} .supporting { margin-top: -4px; max-width: 320px; color: rgba(186,230,253,.62); font-size: clamp(12px, 3.1vw, 13.5px); line-height: 1.42; font-weight: 760; }
    ...
    #${DIAGNOSIS_ID} .rhythm-visual small, #${DIAGNOSIS_ID} .pulse-visual strong { color: rgba(186,230,253,.55); font-size: 10px; font-weight: 950; letter-spacing: .16em; text-transform: uppercase; }
    ...
    #${DIAGNOSIS_ID} .back-button, #${DIAGNOSIS_ID} .next-button { min-height: 48px; border-radius: 999px; font-size: 12.4px; line-height: 1.16; font-weight: 950; transition: transform .12s ease, opacity .12s ease; }
    #${DIAGNOSIS_ID} .back-button { width: 31%; border: 1px solid rgba(255,255,255,.10); background: rgba(255,255,255,.045); color: rgba(240,253,255,.72); }
    #${DIAGNOSIS_ID} .back-button[disabled] { opacity: 0; pointer-events: none; }
    #${DIAGNOSIS_ID} .next-button { flex: 1; padding: 0 18px; border: 1px solid rgba(255,255,255,.18); background: radial-gradient(circle at 18% 18%, rgba(255,255,255,.34), transparent 25%), linear-gradient(135deg, #67e8f9, #7dd3fc 46%, #a5b4fc); color: #06101f; box-shadow: 0 16px 34px rgba(45,212,191,.18), 0 0 30px rgba(125,211,252,.12), inset 0 1px 0 rgba(255,255,255,.38); }
