...
const EXPERIENCES = {
  en: {
    ...
    intro: `Not just what a budget is — I’ll walk you through why money can disappear even when individual purchases look affordable, how a realistic budget is built, how to use it while you spend, and what to do when the plan does not go perfectly.\n\nYou control the pace. After every important point, you can continue, ask me to explain it another way, or ask a follow-up question.`,
  ...
  tl: {
    ...
    intro: `Hindi lang kung ano ang budget — dadaan tayo sa kung bakit puwedeng mabilis mawala ang pera kahit parang affordable ang bawat individual purchase, paano gumawa ng realistic na budget, paano ito gamitin habang gumagastos, at ano ang gagawin kapag hindi naging perfect ang plano.\n\nIkaw ang may control sa pace. Pagkatapos ng bawat importanteng point, puwede kang magpatuloy, magpa-explain sa ibang paraan, o magtanong ng follow-up question.`,
  ...
  es: {
    ...
    intro: `No solo veremos qué es un presupuesto. Te voy a mostrar por qué el dinero puede desaparecer aunque cada compra individual parezca accesible, cómo construir un presupuesto realista, cómo usarlo mientras gastas y qué hacer cuando el plan no sale perfecto.\n\nTú controlas el ritmo. Después de cada punto importante puedes continuar, pedirme que lo explique de otra manera o hacer una pregunta de seguimiento.`,
