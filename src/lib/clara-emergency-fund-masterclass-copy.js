...
closeMasterclass: "Close Emergency Fund Masterclass",
learnWithClara: "Learn with CLARA",
complete: "Complete",
coreComplete: "Core complete",
pointOf: (point, total) => `Point ${point} of ${total}`,
introQuestion: "Want me to teach you how an emergency fund actually protects you?",
introEyebrow: "CLARA · LET'S LEARN TOGETHER",
lessonEyebrow: (point) => `Emergency Fund Masterclass · Point ${point}`,
coreCompleteTitle: "You made it through the core lesson",
coreCompleteEyebrow: "Emergency Fund Masterclass · Core complete",
gotItTitle: "You got it",
gotItEyebrow: "CLARA · Emergency Fund Masterclass",
startUser: "Start the Emergency Fund Masterclass.",
continueUser: "Continue.",
gotItUser: "I got it now.",
yourReply: "Your reply",
startButton: "Start the Emergency Fund Masterclass",
askMoreButton: "Ask more",
gotItButton: "I got it now",
scheduleButton: "Schedule with CLARA",
backMasterclassButton: "Back to Emergency Fund",
...
composerPlaceholder: "Ask CLARA your Emergency Fund follow-up…",
composerRequired: "Write a short Emergency Fund question first.",
cancelFollowUp: "Cancel follow-up question",
sendFollowUp: "Send follow-up question",
followUpEyebrow: "CLARA · Emergency Fund follow-up",
...
closeMasterclass: "Isara ang Emergency Fund Masterclass",
learnWithClara: "Matuto kasama si CLARA",
complete: "Tapos na",
coreComplete: "Tapos ang core",
pointOf: (point, total) => `Point ${point} sa ${total}`,
introQuestion: "Gusto mo bang ituro ko kung paano ka talaga pinoprotektahan ng emergency fund?",
introEyebrow: "CLARA · SABAY TAYONG MATUTO",
lessonEyebrow: (point) => `Emergency Fund Masterclass · Point ${point}`,
coreCompleteTitle: "Natapos mo ang core lesson",
coreCompleteEyebrow: "Emergency Fund Masterclass · Tapos ang core",
gotItTitle: "Gets mo na",
gotItEyebrow: "CLARA · Emergency Fund Masterclass",
startUser: "Simulan ang Emergency Fund Masterclass.",
continueUser: "Magpatuloy.",
gotItUser: "Gets ko na.",
yourReply: "Sagot mo",
startButton: "Simulan ang Emergency Fund Masterclass",
askMoreButton: "Magtanong pa",
gotItButton: "Gets ko na",
scheduleButton: "Mag-schedule with CLARA",
backMasterclassButton: "Bumalik sa Emergency Fund",
...
composerPlaceholder: "Itanong kay CLARA ang Emergency Fund follow-up mo…",
composerRequired: "Maglagay muna ng maikling Emergency Fund question.",
...
closeMasterclass: "Cerrar la Masterclass de Fondo de Emergencia",
learnWithClara: "Aprende con CLARA",
complete: "Completado",
coreComplete: "Parte principal completa",
pointOf: (point, total) => `Punto ${point} de ${total}`,
introQuestion: "¿Quieres que te enseñe cómo te protege realmente un fondo de emergencia?",
introEyebrow: "CLARA · APRENDAMOS JUNTOS",
lessonEyebrow: (point) => `Masterclass de Fondo de Emergencia · Punto ${point}`,
coreCompleteTitle: "Terminaste la parte principal",
coreCompleteEyebrow: "Masterclass de Fondo de Emergencia · Parte principal completa",
gotItTitle: "Ya lo entendiste",
gotItEyebrow: "CLARA · Masterclass de Fondo de Emergencia",
startUser: "Empezar la Masterclass de Fondo de Emergencia.",
continueUser: "Continuar.",
gotItUser: "Ya lo entendí.",
yourReply: "Tu respuesta",
startButton: "Empezar la Masterclass de Fondo de Emergencia",
askMoreButton: "Preguntar más",
gotItButton: "Ya lo entendí",
scheduleButton: "Programar con CLARA",
backMasterclassButton: "Volver al Fondo de Emergencia",
...
composerPlaceholder: "Hazle a CLARA tu pregunta sobre el Fondo de Emergencia…",
composerRequired: "Escribe primero una pregunta breve sobre el Fondo de Emergencia.",
cancelFollowUp: "Cancelar pregunta",
sendFollowUp: "Enviar pregunta",
followUpEyebrow: "CLARA · Seguimiento del Fondo de Emergencia",
...
title: "Your protection in CLARA",
...
labels: {
monthly: "Monthly survival cost",
targetMonths: "Protection target",
target: "Target reserve",
current: "Current protected reserve",
coverage: "Current protection",
wallet: "Storage wallet",
},
},
tl: {
eyebrow: "YOUR CLARA EXAMPLE",
title: "Protection mo sa CLARA",
...
labels: {
monthly: "Costo mensual de supervivencia",
targetMonths: "Objetivo de protección",
target: "Reserva objetivo",
current: "Reserva protegida actual",
coverage: "Protección actual",
wallet: "Billetera de almacenamiento",
},
},
};
