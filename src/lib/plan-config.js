...
export const PLAN_DEFAULTS = {
  ...
  entry: {
    ...
    name: "Entry",
    price: 299,
    description: "Unlock CLARA's guided starter path and your full money toolkit.",
    features: [
      "Feed and full financial tools",
      "Starter guided program",
      "Modules and tasks",
      "Community and messaging",
    ],
    cta_label: "Unlock Entry",
    active: true,
    popular: false,
    sort_order: 2,
    access_config: {
  ...
  core: {
    ...
    name: "Core",
    price: 599,
    description: "Unlock the full CLARA guided system with your full money toolkit.",
    features: [
      "Feed and full 30-day guided system",
      "Modules and tasks",
      "Community and messaging",
      "Full analytics and goal tracking",
    ],
  ...
  coaching: {
    ...
    name: "Coaching",
    price: 1199,
    description: "Unlock the full CLARA system plus your coaching and support layer.",
    features: [
      "Feed and full 30-day guided system",
