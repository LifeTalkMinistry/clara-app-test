...
const MODE_COPY = {
  login: {
    ...
    title: "Sign in to continue your financial journey",
    button: "Log in",
  ...
  signup: {
    ...
    title: "Start your journey to financial clarity",
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#030507] text-white">
      <div className="absolute inset-0">
        <div className="absolute left-1/2 top-[-14%] h-[28rem] w-[28rem] -translate-x-1/2 rounded-full bg-emerald-500/10 blur-3xl" />
        <div className="absolute right-[-6rem] top-[18%] h-72 w-72 rounded-full bg-green-400/10 blur-3xl" />
        <div className="absolute bottom-[-7rem] left-[-5rem] h-80 w-80 rounded-full bg-cyan-400/10 blur-3xl" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.06),transparent_28%),linear-gradient(180deg,rgba(7,10,12,0.92)_0%,rgba(3,5,7,1)_100%)]" />
      </div>
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-md flex-col justify-center px-4 py-8 sm:px-6">
        <div className="mb-7 flex flex-col items-center text-center">
          ...
          <p className="mt-3 max-w-xs text-sm leading-relaxed text-white/60">
            Premium financial guidance with a calm, secure experience designed for your daily money flow.
          </p>
        </div>
          ...
          <div className="p-5 sm:p-6">
            ...
            <div
              className={`transition-all duration-300 ${
                mode === "signup" ? "translate-y-0 opacity-100" : "translate-y-0 opacity-100"
              }`}
            >
              <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-emerald-300/70">
                {copy.eyebrow}
              </p>
              <h1 className="mt-3 text-[1.9rem] font-bold leading-tight text-white">
                {copy.title}
              </h1>
              <p className="mt-3 text-sm leading-relaxed text-white/62">
                {mode === "login"
                  ? "Pick up where you left off with your budgets, plans, and progress in one place."
                  : "Set up your CLARA account in minutes and start building a clearer, steadier money routine."}
              </p>
            </div>
            ...
            <div className="mt-5 flex items-center justify-center gap-2 text-sm text-white/58">
              ...
              <button
                ...
                className="font-medium text-emerald-300 transition hover:text-emerald-200 focus:outline-none focus:ring-2 focus:ring-emerald-400/30 rounded-md"
              >
