...
const BADGES = Object.freeze({
  supporter: {
    assetSrc: new URL("support-badges/supporter-tier-1.png?v=clara-supporter-clean-20260813-2", document.baseURI).href,
    shellClass:
      ...
      <span className={`clara-support-badge__mark relative z-[1] inline-flex shrink-0 items-center justify-center rounded-full border ${visual.iconClass} ${compact ? "h-4 w-4" : "h-[18px] w-[18px]"}`}>
        {badge.assetSrc ? (
          <img
            ...
            style={normalized === "supporter" ? { filter: "none" } : undefined}
          />
        ) : (
