    ...
    <div className={`relative overflow-visible rounded-2xl border border-white/[0.06] bg-black/[0.10] px-3.5 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.035)] ${menuOpen ? "z-[90]" : "z-0"}`}>
      ...
      <div className="flex items-center gap-3 pl-1.5">
        ...
        <div className="relative shrink-0">
          ...
          {menuOpen ? (
            <div
              className="absolute right-0 top-10 z-[140] w-52 rounded-[22px] border border-white/[0.18] bg-[rgba(12,18,45,0.96)] p-1.5 text-white shadow-[0_18px_45px_rgba(0,0,0,0.45)] backdrop-blur-xl ring-1 ring-cyan-200/10"
