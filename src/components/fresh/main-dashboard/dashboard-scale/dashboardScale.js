...
export const DASHBOARD_SCALE = {
  ultraCompact: {
    ...
    headerPanel: "min-h-[66px] rounded-[22px] px-2 py-1.5 sm:px-2",
    headerItem: "min-h-[50px] gap-0.5 rounded-[14px] px-1 py-1 sm:px-1.5",
  ...
  compact: {
    page: "min-h-0",
    headerOuter: "px-[clamp(12px,3.5vw,16px)] pb-1 pt-[calc(env(safe-area-inset-top)+8px)] md:px-[clamp(12px,3.5vw,16px)]",
    headerPanel: "min-h-[72px] rounded-[23px] px-2 py-1.5 sm:px-2",
    headerItem: "min-h-[54px] gap-0.5 rounded-[15px] px-1 py-1.5 sm:px-1.5",
    headerIcon: "h-8 w-8",
  ...
  normal: {
    page: "min-h-0",
    headerOuter: "px-[clamp(14px,4vw,18px)] pb-1.5 pt-[calc(env(safe-area-inset-top)+8px)] md:px-[clamp(14px,4vw,18px)]",
    headerPanel: "min-h-[72px] rounded-[22px] px-2 py-1.5 sm:px-2.5",
    headerItem: "min-h-[56px] gap-0.5 rounded-[14px] px-1 py-1.5 sm:px-2",
    headerIcon: "h-9 w-9",
  ...
  spacious: {
    page: "min-h-0",
    headerOuter: "px-[clamp(16px,4vw,20px)] pb-1.5 pt-[calc(env(safe-area-inset-top)+10px)] md:px-[clamp(16px,4vw,20px)]",
    headerPanel: "min-h-[76px] rounded-[22px] px-2 py-1.5 sm:px-2.5",
    headerItem: "min-h-[58px] gap-0.5 rounded-[14px] px-1 py-1.5 sm:px-2",
    headerIcon: "h-9 w-9",
    headerIconSvg: "h-[18px] w-[18px]",
    headerLabel: "text-[10.5px]",
