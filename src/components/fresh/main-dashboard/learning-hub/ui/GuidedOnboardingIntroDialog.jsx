  ...
  return createPortal(
    ...
    >
      ...
      <section
        ...
        className="relative h-[calc(100dvh-32px)] max-h-[820px] w-full max-w-[430px] text-white"
      >
        <article className="relative h-full overflow-y-auto rounded-[32px] border border-cyan-100/20 bg-[linear-gradient(150deg,rgba(7,54,71,0.98),rgba(8,20,54,0.99)_48%,rgba(34,14,79,0.99))] shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_24px_72px_rgba(0,0,0,0.46)]">
          ...
          <button
            type="button"
            onClick={onClose}
            className="absolute right-5 top-5 z-20 inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-slate-950/24 text-white/76 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-md transition hover:bg-white/[0.1] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-200"
            aria-label="Close CLARA walkthrough page"
          >
            <X className="h-4 w-4" />
          </button>

          <div className="relative z-10 flex min-h-full flex-col px-5 pb-5 pt-7 sm:px-6 sm:pb-6 sm:pt-8">
            <div className="pr-12">
            ...
            <h1
              ...
              className="mt-6 max-w-[19rem] text-[clamp(2rem,8.5vw,2.45rem)] font-black leading-[0.98] tracking-[-0.05em] text-white"
            >
