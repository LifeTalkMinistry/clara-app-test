...
export default function MonthlyCoachingComingSoonPopover({
  ...
  useEffect(() => {
    ...
    const handlePointerDown = (event) => {
      ...
      onRequestClose({ restoreFocus: !isInteractiveTarget(target) });
    };
  ...
  return createPortal(
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="mt-3 flex flex-col gap-3 min-[360px]:flex-row min-[360px]:items-start min-[360px]:justify-between">
          ...
          <button
            ...
            className="inline-flex min-h-11 shrink-0 self-start items-center justify-center rounded-full border border-cyan-100/25 bg-cyan-300 px-3.5 text-[9px] font-black uppercase tracking-[0.14em] text-slate-950 shadow-[0_10px_24px_rgba(34,211,238,0.22)] transition hover:bg-cyan-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-200 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 active:scale-[0.97]"
          >
            GOT IT
          </button>
        </div>
