  ...
  return (
    <section className="relative w-full overflow-hidden px-1 py-0">
      ...
      <button
        ...
        className="clara-learning-motion relative isolate mx-auto mt-3 mb-3 flex w-fit items-center justify-center gap-2 overflow-hidden rounded-full border px-4 py-2 text-[11px] font-bold uppercase tracking-[0.24em] text-white/72 transition-[transform,background-color,border-color] duration-300 active:scale-[0.98]"
      ...
      <div
        className={`clara-learning-motion grid transition-[grid-template-rows,opacity,margin] duration-500 ease-out ${
          isExpanded ? "mt-0 mb-3 grid-rows-[1fr] opacity-100" : "mt-0 mb-0 grid-rows-[0fr] opacity-0"
        }`}
      >
