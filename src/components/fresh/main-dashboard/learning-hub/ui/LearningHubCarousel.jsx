  ...
  return (
    <section className="relative -mb-1 w-full overflow-hidden px-1 py-0">
      ...
      <button
        ...
        className="clara-learning-motion relative isolate mx-auto mt-3 mb-0 flex w-fit items-center justify-center gap-1.5 overflow-hidden rounded-full border px-3 py-2 text-[10.5px] font-bold uppercase tracking-[0.18em] text-white/64 transition-[transform,background-color,border-color] duration-300 active:scale-[0.98]"
      ...
      >
        ...
        <span className="relative z-10 whitespace-nowrap text-white/74">Learning Hub</span>
        <span className="relative z-10 whitespace-nowrap rounded-full border border-amber-100/38 bg-amber-300/15 px-2.5 py-0.5 text-[9px] font-black tracking-[0.18em] text-amber-50/82 shadow-[0_0_12px_rgba(251,191,36,0.16)] backdrop-blur-sm">
          COMING SOON
        </span>
        <ChevronDown size={15} className="relative z-10 text-cyan-100/40" />
      </button>
