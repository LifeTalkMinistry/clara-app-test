...
function DailyTipGuideBubble() {
  return (
    <div className="pointer-events-none absolute left-1/2 top-full z-[100] mt-3 w-[min(92vw,372px)] -translate-x-1/2">
  ...
  return (
    <section className="clara-budget-focus-shift clara-budget-focus-hub w-full">
      <div className="relative flex w-full flex-col gap-[var(--clara-hub-rail-gap,14px)] overflow-visible px-1 py-0">
        <div className={`${isDailyTipGuideActive ? "relative z-[90]" : "relative"} overflow-visible`}>
          <DailyTipCard
