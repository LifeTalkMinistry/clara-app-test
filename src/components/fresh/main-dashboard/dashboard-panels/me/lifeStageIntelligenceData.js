...
export const LIFE_STAGE_INTELLIGENCE = {
  ...
  "Family Household": stage(
    ...
    "Family Household life shapes spending through shared food, bills, requests, emergencies, support pressure, and the emotional challenge of helping without losing personal stability.",
    {
      ...
      rhythm: ["Fixed household contribution", "Requests are unpredictable", "Shared food and bills", "Personal money becomes backup"],
      workload: ["Often interrupted by home needs", "Emotionally draining support role", "Boundary conflict at home", "Rest feels hard to protect"],
      pressure: ["Food and bills", "Family requests", "Education or medical support", "Emergency help"],
      coping: ["I give even when tight", "I hide my money stress", "I delay my own needs", "I set limits then feel guilty"],
      goal: ["Contribute wisely", "Build personal buffer", "Set family boundaries", "Protect my own stability too"],
    },
    [
  ...
  "Single Parent": stage(
    ...
    "Single Parents carry child-centered decisions, irregular support risk, emergency pressure, and high responsibility with limited margin for mistakes.",
    {
      ...
      rhythm: ["Stable income and routine", "Support comes irregularly", "School expense cycles", "Bills and child costs overlap"],
      workload: ["Always busy", "Limited childcare support", "Emotionally exhausted", "Care and work overlap"],
      pressure: ["Daily essentials", "School or childcare costs", "Emergency or health costs", "Debt or borrowed money"],
      coping: ["I sacrifice my own needs", "I borrow when urgent", "I buy comfort for my child", "I avoid checking money"],
      goal: ["Protect essentials", "Emergency fund first", "Build a small safety buffer", "Secure my child’s future"],
    },
    [
  ...
  "Full-Time Earner": stage(
    ...
    "Full-Time Earners usually have predictable income, but cutoff dependency, routine fatigue, family support, and stress-reward spending can quietly weaken financial stability.",
    {
      ...
      rhythm: ["Fixed monthly salary", "Twice-a-month cutoff", "Stable pay but tight budget", "Payday feels strong then fades"],
      workload: ["Predictable routine", "Long work hours", "Shift fatigue", "Routine burnout cycle"],
      pressure: ["Cutoff dependency", "Household or family support", "Debt or installment pressure", "Subscriptions and bills stacking"],
      coping: ["Payday reward spending", "Convenience spending after work", "I ignore the budget when tired", "I promise to fix it next cutoff"],
      goal: ["Save consistently", "Emergency fund first", "Control payday spending", "Stop salary leaks"],
    },
    [
  ...
  "Freelance Season": stage(
    ...
    "Freelance Season brings flexibility, but unstable payment timing, underpricing, overwork, and personal-business mixing make financial structure essential.",
    {
      ...
      rhythm: ["Recurring clients", "Project waves", "Feast/famine cycle", "Delayed payments"],
      workload: ["Flexible but manageable", "Busy client season", "Overworked and unclear", "No rest structure"],
      pressure: ["Income variability", "Client delays", "Dry month risk", "Personal/business mixing"],
      coping: ["I spend after big payments", "I underprice to keep clients", "I avoid planning dry months", "I overwork when anxious"],
      goal: ["Build cash buffer", "Stabilize income", "Separate wallets", "Prepare for dry months"],
    },
    [
  ...
  "Business Builder": stage(
    ...
    "Business Builders carry growth pressure, capital decisions, unstable profit, reinvestment tension, and blurred boundaries between personal and business money.",
    {
      ...
      rhythm: ["Sales not steady", "Monthly business cycle", "Reinvesting heavily", "Cash flow swings"],
      workload: ["Long operating hours", "Decision overload", "Founder burnout", "No clear off-switch yet"],
      pressure: ["Operating costs", "Inventory or capital pressure", "Personal/business mix", "Sales uncertainty"],
      coping: ["I reinvest too quickly", "I mix personal and business money", "I delay paying myself", "I chase growth before stability"],
      goal: ["Separate money", "Build runway", "Grow sustainably", "Pay myself properly"],
    },
    [
