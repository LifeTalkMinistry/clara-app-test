...
function LifeStageSetupGate({ onSetup }) {
  return (
    <div className="relative flex h-full min-h-0 flex-col overflow-hidden rounded-[30px] bg-[#062033] px-3 pb-3 pt-1 shadow-[inset_0_0_0_1px_rgba(255,255,255,.055)]">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_16%_6%,rgba(103,248,255,.34),transparent_31%),radial-gradient(circle_at_86%_10%,rgba(147,197,253,.32),transparent_34%),linear-gradient(180deg,rgba(14,116,144,.24),rgba(37,99,235,.16)_45%,rgba(2,8,23,.74))]" />
      <div className="pointer-events-none absolute inset-x-3 bottom-3 top-1 overflow-hidden rounded-[30px] opacity-80 blur-[0.4px] grayscale-[0.25]">
        <section className="relative min-h-0 flex-[1.25] overflow-hidden rounded-b-[30px] bg-gradient-to-br from-cyan-300/20 via-blue-400/14 to-violet-400/18 px-5 pb-5 pt-5 shadow-[0_22px_80px_rgba(0,0,0,.18)]">
          <div className="absolute inset-x-0 bottom-0 h-[62%] bg-[linear-gradient(180deg,transparent,rgba(7,18,38,.72))]" />
          <div className="absolute bottom-0 right-0 h-full w-[56%] bg-[radial-gradient(circle_at_50%_35%,rgba(224,242,254,.40),transparent_34%),linear-gradient(145deg,rgba(125,211,252,.30),rgba(59,130,246,.14))]" />
          <div className="relative z-10 flex h-full max-w-[62%] flex-col justify-center pt-3"><p className="text-[9px] font-black uppercase tracking-[0.15em] text-white/68">Money Profile</p><h2 className="mt-2 text-[clamp(22px,7vw,31px)] font-black leading-[1.02] text-white">Life Stage Not Set</h2><p className="mt-2 text-[12px] font-semibold leading-5 text-white/62">Personalized insights locked</p></div>
        </section>
      ...
      <div className="relative z-10 flex min-h-0 flex-1 items-center justify-center px-2 py-6">
        <section className="w-full max-w-[352px] overflow-hidden rounded-[30px] border border-white/70 bg-[linear-gradient(180deg,rgba(248,250,252,.96),rgba(224,242,254,.90)_52%,rgba(219,234,254,.86))] p-5 text-center shadow-[0_26px_84px_rgba(8,47,73,.34),0_0_54px_rgba(125,211,252,.28),inset_0_1px_0_rgba(255,255,255,.90)] backdrop-blur-2xl">
          <div className="mx-auto inline-flex rounded-full border border-cyan-700/18 bg-cyan-100/80 px-3 py-1 text-[9px] font-black uppercase tracking-[0.18em] text-cyan-950">Personalization needed</div>
          <div className="mx-auto mt-5 grid h-16 w-16 place-items-center rounded-[24px] border border-cyan-900/10 bg-white/72 text-cyan-900 shadow-[0_14px_34px_rgba(14,116,144,.18)]"><Sparkles className="h-7 w-7" /></div>
          <h2 className="mt-5 text-[28px] font-black leading-[1.02] tracking-[-0.04em] text-slate-950">Personalize your Money Profile</h2>
          <p className="mt-4 text-[13px] font-semibold leading-6 text-slate-700">Set your life stage so CLARA can understand your real responsibilities, pressure points, and money behavior.</p>
          ...
          <p className="mt-4 text-[11px] font-semibold leading-5 text-slate-600">This helps CLARA personalize your reminders, spending signals, and financial safety insights.</p>
        </section>
      </div>
    </div>
  );
