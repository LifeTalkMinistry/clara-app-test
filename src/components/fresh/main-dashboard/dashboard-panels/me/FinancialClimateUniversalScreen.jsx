...
function LifeStageSetupGate({ onSetup }) {
  return (
    <div className="relative isolate flex h-full min-h-0 flex-col overflow-hidden rounded-[30px] bg-[#0b2742] px-3 pb-3 pt-1 shadow-[inset_0_0_0_1px_rgba(255,255,255,.07)]">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_16%_6%,rgba(103,248,255,.36),transparent_31%),radial-gradient(circle_at_86%_10%,rgba(147,197,253,.36),transparent_34%),linear-gradient(180deg,rgba(14,116,144,.30),rgba(37,99,235,.18)_45%,rgba(2,8,23,.66))]" />
      <div className="pointer-events-none absolute inset-x-3 bottom-3 top-1 -z-0 overflow-hidden rounded-[30px] opacity-32 blur-[0.2px] grayscale-[0.25]">
        <section className="relative min-h-0 flex-[1.25] overflow-hidden rounded-b-[30px] bg-gradient-to-br from-cyan-300/22 via-blue-400/16 to-violet-400/18 px-5 pb-5 pt-5 shadow-[0_22px_80px_rgba(0,0,0,.14)]">
          <div className="absolute inset-x-0 bottom-0 h-[62%] bg-[linear-gradient(180deg,transparent,rgba(7,18,38,.66))]" />
          <div className="absolute bottom-0 right-0 h-full w-[56%] bg-[radial-gradient(circle_at_50%_35%,rgba(224,242,254,.42),transparent_34%),linear-gradient(145deg,rgba(125,211,252,.30),rgba(59,130,246,.14))]" />
          <div className="relative z-10 flex h-full max-w-[62%] flex-col justify-center pt-3"><p className="text-[9px] font-black uppercase tracking-[0.15em] text-white/72">Money Profile</p><h2 className="mt-2 text-[clamp(22px,7vw,31px)] font-black leading-[1.02] text-white">Life Stage Not Set</h2><p className="mt-2 text-[12px] font-semibold leading-5 text-white/66">Personalized insights locked</p></div>
        </section>
        <section className="mt-3 rounded-[24px] border border-white/[0.12] bg-[#0f2a45]/64 p-3 backdrop-blur-xl"><div className="flex items-center justify-between gap-3"><div className="min-w-0 flex-1"><h3 className="text-[14px] font-black text-white">Set your Life Stage to unlock your Money Profile</h3><p className="mt-1 text-[12px] font-semibold leading-5 text-white/58">CLARA is waiting for your real context.</p></div><div className="grid h-16 w-16 shrink-0 place-items-center rounded-full border border-violet-100/30 bg-violet-100/16"><Heart className="h-7 w-7 fill-violet-50 text-violet-50" /></div></div></section>
        <section className="mt-3 rounded-[24px] border border-white/[0.12] bg-[#0f2a45]/56 p-3 backdrop-blur-xl"><div className="flex items-center justify-between gap-3"><div><h3 className="text-[14px] font-black text-white">Life Stage Trend Snapshot</h3><p className="mt-0.5 text-[10px] font-semibold text-white/52">Locked until setup is complete.</p></div><Sparkles className="h-4 w-4 text-cyan-50/60" /></div><div className="mt-3 grid grid-cols-3 gap-2.5">{["Responsibilities", "Pressure", "Safety"].map((label) => <div key={label} className="rounded-[16px] border border-white/[0.12] bg-white/[0.08] p-3"><p className="text-[9px] font-black tracking-tight text-white/58">{label}</p><p className="mt-3 h-5 w-12 rounded-full bg-white/[0.18]" /><p className="mt-3 text-[9px] font-black text-cyan-50/70">Locked</p></div>)}</div></section>
      </div>
      <div className="relative z-20 flex min-h-0 flex-1 items-center justify-center px-2 py-6">
        <section className="w-full max-w-[352px] overflow-hidden rounded-[30px] border border-white bg-white p-5 text-center shadow-[0_26px_84px_rgba(8,47,73,.38),0_0_54px_rgba(125,211,252,.28),inset_0_1px_0_rgba(255,255,255,.95)]">
          <div className="mx-auto inline-flex rounded-full border border-cyan-700/18 bg-cyan-100 px-3 py-1 text-[9px] font-black uppercase tracking-[0.18em] text-cyan-950">Personalization needed</div>
          <div className="mx-auto mt-5 grid h-16 w-16 place-items-center rounded-[24px] border border-cyan-900/10 bg-cyan-50 text-cyan-900 shadow-[0_14px_34px_rgba(14,116,144,.18)]"><Sparkles className="h-7 w-7" /></div>
          <h2 className="mt-5 text-[28px] font-black leading-[1.02] tracking-[-0.04em] text-slate-950">Personalize your Money Profile</h2>
          <p className="mt-4 text-[13px] font-bold leading-6 text-slate-700">Set your life stage so CLARA can understand your real responsibilities, pressure points, and money behavior.</p>
          <button type="button" onClick={onSetup} className="mt-6 flex min-h-[56px] w-full items-center justify-center rounded-[22px] border border-cyan-950/10 bg-[linear-gradient(135deg,#0f172a,#164e63_48%,#2563eb)] px-5 py-4 text-sm font-black uppercase tracking-[0.08em] text-white shadow-[0_18px_42px_rgba(37,99,235,.30),0_0_34px_rgba(14,116,144,.18)] active:scale-95">SET LIFE STAGE NOW</button>
          <p className="mt-4 text-[11px] font-bold leading-5 text-slate-600">This helps CLARA personalize your reminders, spending signals, and financial safety insights.</p>
        </section>
      </div>
    </div>
  );
...
function LifeStageSetupScreen({ profile, onClose, onSave }) {
  ...
  return (
    <div className="fixed inset-y-0 left-1/2 z-[9999] flex h-[100svh] w-full max-w-[430px] -translate-x-1/2 flex-col overflow-hidden bg-[#020817] px-4 pb-[max(16px,env(safe-area-inset-bottom))] pt-[max(18px,env(safe-area-inset-top))] shadow-[0_24px_90px_rgba(0,0,0,.62),inset_0_0_0_1px_rgba(255,255,255,.04)]">
      ...
      <footer className="relative z-10 mt-4 flex shrink-0 gap-4"><button type="button" onClick={goBack} className="flex min-h-[58px] flex-1 items-center justify-center gap-2 rounded-[22px] border border-cyan-200/20 bg-[#061327]/78 px-5 py-4 text-sm font-black text-white/86 shadow-[0_16px_38px_rgba(0,0,0,.28),inset_0_1px_0_rgba(255,255,255,.05)] backdrop-blur-xl active:scale-95">{stepIndex <= 0 ? "Cancel" : <><ChevronLeft className="h-4 w-4" /> Back</>}</button><button type="button" onClick={goNext} className="flex min-h-[58px] flex-1 items-center justify-center gap-2 rounded-[22px] border border-white/20 bg-[linear-gradient(135deg,#67f8ff,#8bdcff_46%,#72a9ff)] px-5 py-4 text-sm font-black text-slate-950 shadow-[0_18px_42px_rgba(103,248,255,.24),0_0_34px_rgba(125,211,252,.22)] active:scale-95">{stepIndex === stepOrder.length - 1 ? <><Check className="h-4 w-4" /> Apply stage</> : "Continue"}</button></footer>
    </div>
  );
}
