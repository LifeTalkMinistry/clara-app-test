export default function FeaturePageLoader({ label = "Loading feature..." }) {
  return (
    <div className="mx-auto max-w-5xl p-4 md:p-6">
      <div className="theme-panel-card overflow-hidden rounded-[28px] shadow-[0_18px_45px_rgba(0,0,0,0.18)]">
        ...
        <div className="px-5 pb-5 text-sm text-[color:var(--theme-muted-text)]">{label}</div>
      </div>
    </div>
  );
}
