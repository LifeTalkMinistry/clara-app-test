...
export default function ThemePicker() {
  ...
  return (
    <Sheet open={pickerOpen} onOpenChange={setPickerOpen}>
      <SheetContent
        side="bottom"
        className="mx-auto flex h-[86vh] max-h-[860px] w-full max-w-4xl flex-col rounded-t-[32px] border p-0 sm:bottom-4 sm:h-[78vh] sm:rounded-[32px]"
        style={{
        ...
        <div className="relative overflow-hidden border-b px-5 pb-5 pt-6 sm:px-6">
          ...
          <div className="relative flex items-start justify-between gap-4">
            ...
            <button
              ...
              className="flex h-11 w-11 items-center justify-center rounded-2xl border bg-white/5 text-white/70 transition hover:bg-white/10 hover:text-white"
              style={{ borderColor: "color-mix(in srgb, var(--theme-border) 35%, transparent)" }}
                  ...
                  {group.items.map((theme) => {
                    ...
                    return (
                      <button
                        ...
                        className="group overflow-hidden rounded-[26px] border text-left transition duration-200 hover:-translate-y-[1px]"
                        style={{
                          borderColor: active
                      ...
                      >
                        <div
                          ...
                          style={{
                            ...
                            borderColor: "color-mix(in srgb, var(--theme-border) 20%, transparent)",
                          }}
                        >
