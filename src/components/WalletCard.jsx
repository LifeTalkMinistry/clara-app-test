    ...
    >
      ...
      {editingWallet && (
        <div className="fixed inset-0 z-[9999] flex items-end justify-center bg-black/70 px-4 py-5 backdrop-blur-sm sm:items-center">
          <div className="w-full max-w-md overflow-hidden rounded-[30px] border border-white/10 bg-[#030914] text-white shadow-[0_30px_90px_rgba(0,0,0,0.72),0_0_44px_rgba(16,185,129,0.16)]">
            <div className="relative border-b border-white/10 px-5 py-5">
              ...
              <div className="pr-12">
                <div className="mb-3 inline-flex items-center rounded-full border border-emerald-300/15 bg-emerald-400/10 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.18em] text-emerald-100/85">
                  Wallet setup
                </div>
            ...
            <div className="space-y-5 px-5 py-5">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="h-12 w-full rounded-2xl border border-white/15 bg-white/[0.07] px-4 text-white outline-none placeholder:text-white/35 focus:border-emerald-300/45 focus:ring-2 focus:ring-emerald-400/20"
                />
              </div>
                  ...
                  {walletTypes.map((type) => (
                    <button
                      ...
                      className={`rounded-2xl border px-2.5 py-3 text-center text-xs font-bold capitalize transition active:scale-[0.98] ${
                        editForm.type === type
                          ? "border-emerald-300/45 bg-emerald-400/15 text-emerald-50 shadow-[0_0_26px_rgba(16,185,129,0.14)]"
