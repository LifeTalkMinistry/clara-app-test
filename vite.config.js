...
import { savingsGoalWalletReconciliationPlugin } from "./src/build/savingsGoalWalletReconciliationTransform.js";
...
export default defineConfig({
  plugins: [
    savingsGoalManagedBalancePlugin(),
    savingsGoalWalletReconciliationPlugin(),
    react(),
  ],
